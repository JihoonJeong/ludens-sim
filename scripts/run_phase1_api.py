#!/usr/bin/env python3
"""Phase 1 API 본실험 배치 — Flash + GPT-4o-mini 12 runs 순차 실행"""
...
RUN_ORDER = [
    # Flash KO
    "p1_flash_ko_01", "p1_flash_ko_02", "p1_flash_ko_03",
    # Flash EN
    "p1_flash_en_01", "p1_flash_en_02", "p1_flash_en_03",
    # GPT-4o-mini KO
    "p1_gpt4o_ko_01", "p1_gpt4o_ko_02", "p1_gpt4o_ko_03",
    # GPT-4o-mini EN
    "p1_gpt4o_en_01", "p1_gpt4o_en_02", "p1_gpt4o_en_03",
]
...
def main():
    print("=== Phase 1 API Experiment — 12 Runs (Flash + GPT-4o-mini) ===\n")
